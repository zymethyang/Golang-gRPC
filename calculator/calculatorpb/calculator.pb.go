...
var file_calculator_calculatorpb_calculator_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0xa9, 0x01, 0x0a, 0x10, 0x43, 0x61, 0x6c, 0x63, 0x75,
...
var file_calculator_calculatorpb_calculator_proto_depIdxs = []int32{
	...
	1, // 2: calculator.CalculateService.Sum:input_type -> calculator.SumRequest
	4, // 3: calculator.CalculateService.PrimeNumberDec:input_type -> calculator.PrimeNumberDecRequest
	2, // 4: calculator.CalculateService.Sum:output_type -> calculator.SumResponse
	5, // 5: calculator.CalculateService.PrimeNumberDec:output_type -> calculator.PrimeNumberDecResponse
